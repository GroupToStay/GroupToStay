  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          hotel_approval_status: Database["public"]["Enums"]["hotel_approval_status"] | null;
          id: string;
    ...
    Enums: {
      ...
      notification_type:
        ...
        | "rfq_awarded"
        | "rfq_closed";
      offer_status: "submitted" | "accepted" | "rejected" | "withdrawn" | "expired" | "superseded";
      organization_membership_role:
        ...
        | "reservations"
        | "viewer";
      organization_membership_status: "invited" | "active" | "suspended" | "removed";
      organization_status: "active" | "suspended" | "archived";
      organization_type: "agency" | "supplier" | "corporate_buyer";
      quote_status: "submitted" | "shortlisted" | "accepted" | "rejected" | "withdrawn" | "viewed";
      rfq_status:
        | "draft"
        | "open"
        | "closed"
...
export const Constants = {
  ...
  public: {
    Enums: {
      agency_verification_status: ["draft", "submitted", "pending_review", "verified", "rejected"],
      app_role: ["organizer", "hotel", "admin"],
      board_type: ["room_only", "breakfast", "half_board", "full_board"],
      booking_status: ["confirmed", "cancelled", "completed"],
      deal_status: ["active", "agreed", "closed", "cancelled"],
      ...
      offer_status: ["submitted", "accepted", "rejected", "withdrawn", "expired", "superseded"],
      organization_membership_role: ["owner", "admin", "agent", "sales", "reservations", "viewer"],
      organization_membership_status: ["invited", "active", "suspended", "removed"],
      organization_status: ["active", "suspended", "archived"],
      organization_type: ["agency", "supplier", "corporate_buyer"],
      quote_status: ["submitted", "shortlisted", "accepted", "rejected", "withdrawn", "viewed"],
      rfq_status: ["draft", "open", "closed", "awarded", "cancelled", "quoting", "under_review"],
    },
  },
} as const;
