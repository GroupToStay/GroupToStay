...
export const Route = createFileRoute("/subscription/coming-soon")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Hotel subscription plans are launching soon. Join the waitlist to be notified.",
      },
    ],
  }),
      ...
      <main className="flex-1 container-page py-16">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-muted-foreground">
            We are currently preparing secure online payment services. Hotel subscription plans will
            be available soon. Join the waiting list and we will notify you immediately when
            subscriptions become available.
          </p>
        </div>
