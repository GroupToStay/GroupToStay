...
Localization certification adds route-by-route English/Arabic verification, RTL/LTR and responsive evidence, accessible form labels, localized calendar announcements, and production bundle checks. See `Localization-Certification-Report.md` for verified evidence and the remaining role/browser blockers.
